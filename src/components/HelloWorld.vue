<template>
  <div class="hello">
    ...
    <ul>
      ...
      <li>
        <a href="https://github.com/vuejs/vue-cli/tree/dev/packages/%40vue/cli-plugin-e2e-webdriverio" target="_blank"
          rel="noopener">e2e-webdriverio</a>
      </li>
    </ul>
  ...
  <button id="buttonIncrement" @click="onIncrement">increment {{ count }}</button>
</template>
